INSERT INTO cliente (nome, nascimento, cpf, origem, score) VALUES
...
INSERT INTO produto (nome, valor, categoria_id) VALUES
    ('JANELA MAD ECOLY', 5011, 1),
    ('TANQUE FIBRA BAKOF 2500L', 365.50, 1),
    ('BOCAL TERMOFUSÃO TIGRE 25 MM', 6553, 1),
    ...
    ('BALCÃO DCOSTA 1 PORTA TC81 BP', 3551, 2),
    ...
    ('TELEF CEL NOKIA 1208 GSM VIVO SC', 4605, 4),
...
INSERT INTO pedido_produto (pedido_id, produto_id, valor_produto) VALUES
    (24, 9, 3551),
    (39, 2, 366),
    (1, 7, 7289),
    (15, 20, 4886),
